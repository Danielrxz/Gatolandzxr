...
await conn.reply(m.chat, `> ⚔️ Se elimino a @${m.sender.split`@`[0]} por el  \`Anti-Link\`! No se permiten enlaces de ${isChannelLink ? 'canales' : 'otros grupos'}.`, null, { mentions: [m.sender] })
if (isBotAdmin) {
try {
...
console.error("⚔️ No se pudo eliminar el mensaje o expulsar al usuario:", error)
}}}
return !0
}
