...
edit = `⚔️ ${usuario} Ha permitido que ${m.messageStubParameters[0] == 'on' ? 'solo admins' : 'todos'} puedan configurar el grupo.`
...
admingp = `⚔️ @${m.messageStubParameters[0].split`@`[0]} Ahora es admin del grupo.\n\n> 🙄 Acción hecha por:\n> » ${usuario}`
noadmingp = `⚔️ @${m.messageStubParameters[0].split`@`[0]} Deja de ser admin del grupo.\n\n> 🧐 Acción hecha por:\n> » ${usuario}`
