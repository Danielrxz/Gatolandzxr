...
const handler = async (m, {conn, usedPrefix, command}) => {
  ...
  if (!/image\/(jpe?g|png)/.test(mime)) return m.reply(`☁️ El formato del archivo (${mime}) no es compatible, envía o responde a una imagen.`)
  conn.reply(m.chat, `⚔️ Mejorando la calidad....`, m)  
