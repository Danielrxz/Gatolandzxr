...
let handler = async (m, { conn }) => {
  ...
  let pp = await conn.profilePictureUrl(who).catch(_ => 'https://cdn.russellxz.click/5b7e4d78.jpeg');
  ...
  await sendContactArray(conn, m.chat, [
    [`${suittag}`, `☁️` Creador, botname, `⚔️ No Hacer Spam`, correo, `Mexico •˚⊹`, md, bio],
    [`${conn.user.jid.split('@')[0]}`, `✦ Es Un Bot de wiskeys sokets`, packname, dev, correo, channel, biobot]
  ], m);
}
